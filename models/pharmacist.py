...
class Bill:
    ...
    def __str__(self):
        return f"Bill[ID={self.bill_id}], Type={self.bill_type}, PatientID={self.patient_id}, RefID={self.ref_id}, Total={self.total_amount}, Status={self.status}, Date={self.bill_date}"
